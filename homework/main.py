...
@app.teardown_appcontext    #decorador que cuando termine corre esta funcion=teardown
...
#
def getparts():    #obtiene las partes
...
def requestparts():  #actualiza la BD
    """Update part quantity for given part number."""

    global PARTLIST
    global MESSAGE

    part_no = request.form["part_requested"]    #cajitas de la app
...
if __name__ == "__main__":
    ...
    #siempre al ejecutar este tipo flask de apps el link para abrir es este: http://127.0.0.1:5000/